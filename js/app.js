...
const LOCALE_INLINE_FALLBACK = {
    'zh-TW': {
        ...
        onboardWelcomeTitle: '歡迎！我們帶你建立第一個計時器',
        onboardWelcomeBody: '這個 App 和一般程式不太一樣：左側（或手機的「管理」）負責設定，右側主畫面顯示倒數。接下來會一步一步帶你操作。',
        onboardOpenStartTitle: '打開「開新計時器」',
        onboardOpenStartBodyDesktop: '請點左側高亮的「開新計時器」，展開啟動表單（若已展開可直接按下一步）。',
        onboardOpenStartBodyMobile: '請點主畫面上方高亮的「開新計時器」，從底部拉出啟動表單。',
        onboardPickRoleTitle: '選帳號與角色',
        onboardPickRoleBody: '在這裡選要用哪個遊戲帳號、哪個角色。第一次使用可先沿用預設的「帳號1／角色1」。',
        onboardPickTaskTitle: '選任務類型',
        onboardPickTaskBody: '選一個任務標籤（例如訓練、採集）。若該標籤有子項目，會多一個「內容」下拉選單。',
        onboardSetTimeTitle: '設定倒數時間',
        onboardSetTimeBody: '輸入天、時、分、秒，或點快捷鍵（建議先試「+1分」）。上方大字會同步顯示總時長。',
        onboardStartTitle: '開始計時',
        onboardStartBody: '時間設好後，點「開始計時」。成功後主畫面會出現倒數卡片。',
        onboardDoneTitle: '完成！',
        onboardDoneBody: '你的第一個計時器已在主畫面運作。之後可從「系統與主題」重新開啟互動教學或閱讀完整說明。',
        onboardSkip: '略過教學',
        onboardNext: '下一步',
        onboardFinish: '完成教學',
        onboardStepLabel: '步驟 {n} / {total}',
        onboardNeedTimeHint: '請先設定時間（例如點「+1分」），再按下一步。',
        onboardNeedStartHint: '請點「開始計時」建立你的第一個計時器。',
        onboardNeedOpenStartDesktop: '請先點左側「開新計時器」展開表單。',
        onboardNeedOpenStartMobile: '請先點上方「開新計時器」打開表單。'
    },
    'zh-CN': {
        panelFabOpen: '管理',
        openPanel: '打开管理面板',

...
const LOCALE_INLINE_FALLBACK = {
    'zh-TW': {
        ...
        taskStart: '開新計時器',
        timerEntryHome: '進入主頁',
        timerEntryAddNew: '新增計時器',
        timerWizardStepAcc: '帳號與角色',
        timerWizardStepTask: '任務與子項目',
        timerWizardStepTime: '設定時間',
        timerWizardStepDone: '完成',
        timerWizardStepOf: '步驟 {n} / {total}',
        timerWizardNext: '下一步',
        timerWizardBack: '上一步',
        timerWizardFinish: '完成',
        timerWizardAccHint: '先選要計時的遊戲帳號，再選角色。',
        timerWizardTaskHint: '選任務類型；有子項目時可再細分（例如盾兵、矛兵）。',
        timerWizardTimeHint: '點下方快捷按鈕加時間，或輸入天／時／分／秒。',
        timerWizardDoneHint: '確認以下內容，按「完成」開始倒數。',
        timerWizardNeedChar: '此帳號尚無角色，請到左側「帳號管理」新增角色。',
        timerWizardNeedTime: '請先設定大於 0 的時間。',
        timerWizardSummaryAcc: '帳號',
        timerWizardSummaryChar: '角色',
        timerWizardSummaryTask: '任務',
        timerWizardSummaryTime: '倒數時間',
        ...
        accountHeaderDisplay: '計時器分組方式',
        accountHeaderOn: '依帳號',
        accountHeaderOff: '依角色',
    ...
    'zh-CN': {
        ...
        timerWizardStepAcc: '账号与角色',
        timerWizardStepTask: '任务与子项目',
        timerWizardStepTime: '设定时间',
        timerWizardStepDone: '完成',
        timerWizardStepOf: '步骤 {n} / {total}',
        timerWizardNext: '下一步',
        timerWizardBack: '上一步',
        timerWizardFinish: '完成',
        timerWizardAccHint: '先选要计时的游戏账号，再选角色。',
        timerWizardTaskHint: '选任务类型；有子项目时可再细分（例如盾兵、矛兵）。',
        timerWizardTimeHint: '点下方快捷按钮加时间，或输入天／时／分／秒。',
        timerWizardDoneHint: '确认以下内容，按「完成」开始倒数。',
        timerWizardNeedChar: '此账号尚无角色，请到左侧「账号管理」新增角色。',
        timerWizardNeedTime: '请先设定大于 0 的时间。',
        timerWizardSummaryAcc: '账号',
        timerWizardSummaryChar: '角色',
        timerWizardSummaryTask: '任务',
        timerWizardSummaryTime: '倒数时间',
...
function updateTimersDataTicker(skipRelayout = false) {
    ...
    if (needsRelayout && !skipRelayout) dispatchTimersToDOM();
        ...
        updateClearFinishedButtonHighlight();
        requestAnimationFrame(() => {
            if (!isTimerDisplayClean()) fitAllFinishedTimerCardLabels();
            syncTimerListSideAlign();
        });
    }
}
